...
var languageParadigm = ["Multi-paradigm: imperative (procedural), structured.",
...
List<ProgrammingLanguage> listData() {
  List<ProgrammingLanguage> list = [];
  for (int position = 0; position < languageId.length; position++) {
    list.add(ProgrammingLanguage(id: languageId[position], name: languageNames[position], paradigm: languageParadigm[position], developer: languageDeveloper[position], detail: languageDetails[position], image: languageImages[position]));
  }
  return list;
}